...
george_wickham = User.create(name: "George Wikham", age: "120", gender: "M", description: "Cad")

harry_potter_match = Match.create(name: "Harry Potter", age: "26", gender: "M", description: "looking for wizardly love")
bridget_jones_match = Match.create(name: "Bridget Jones", age: "45", gender: "F", description: "looking for anyone who is not alcoholic or smug married")
lizzie_bennet_match = Match.create(name: "Elizabeth Bennet", age: "110", gender: "F", description: "Need rich husband")
george_wickham_match = Match.create(name: "George Wikham", age: "120", gender: "M", description: "Cad")
